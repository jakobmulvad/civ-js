...
export const fonts = {
  main: {
    ...
    kerning: [
      ...
      6, 6, 6, 4, 6, 6, 6, 7, 6, 6, 6, 6, 6, 6, 6, 6, 7, 7, 6, 6, 6, 3, 7, 3, 6, 6, 8, 5, 5, 4, 5, 5, 3, 5, 4, 2, 4, 4,
  ...
  mainSmall: {
    ...
    height: 6,
    kerning: [
      3, 2, 1, 8, 4, 8, 8, 2, 2, 3, 4, 3, 2, 3, 2, 3, 4, 3, 4, 4, 4, 4, 4, 4, 4, 4, 2, 2, 3, 3, 3, 4, 8, 4, 4, 4, 4, 4,
